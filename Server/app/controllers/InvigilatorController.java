...
public class InvigilatorController extends Controller {
     ...
     *<ul>
     *      <li>examIds: a list of examIds, whose corresponding {@link Exam exam records} the invigilator requestes to sign in for</li>
     *</ul>
     * 
     * @return An on-going invigilation page rendered with a list of Exam as parameter.
     */
    ...
    /**
     * Gets the latest unseen image and all unread images for a {@link Exam exam record}.
     * 
     * @param  examId                the id of exam record whose chat and image will be queried on.
     ...
     * <ul>
     *     <li>examId: {@link Exam#examId ID of the exam record} that this message belongs to</li>
    ...
    public static Result sendMessage(){
        ...
        try{
            ...
            // extract exam info from form received, locate the corresponding exam report
     ...
     * </ul>
     * and based on it, the status of {@link Exam exam record} (which is actually stored in the {@link Report} object 
     ...
     *     <li>examId: used to locate the {@link Exam exam record} that the remark is supposed to be made on</li>
     * </ul>
